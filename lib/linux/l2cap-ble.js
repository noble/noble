...
L2capBle.prototype.l2capBleWrite = function(message) {
  if (this._l2capBle) {
    ...
    console.warn('L2capBle: Cannot write to l2cap-ble, message: ' + message.trim());
  } else {
    console.warn('L2capBle: Cannot write to l2cap-ble, unknown message');
  }
};
...
L2capBle.prototype.l2capBleKill = function(signal) {
  if (this._l2capBle) {
    ...
    console.warn('L2capBle: Cannot kill l2cap-ble, signal: ' + signal);
  } else {
    console.warn('L2capBle: Cannot kill l2cap-ble, signal: SIGTERM');
  }
};
