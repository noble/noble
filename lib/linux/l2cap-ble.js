...
var L2capBle = function(address, addressType, connParams) {
  ...
  if (connParams) {
    this._connParams.minInterval = connParams.minInterval || this._connParams.minInterval;
    this._connParams.maxInterval = connParams.maxInterval || this._connParams.maxInterval;
    this._connParams.latency = connParams.latency || this._connParams.latency;
    this._connParams.supervisionTimeout = connParams.supervisionTimeout || this._connParams.supervisionTimeout;
  }
...
L2capBle.prototype.connect = function() {
  ...
  this._l2capBle = spawn(l2capBle, [
    '--bdaddr', this._address,
    '--bdaddr_type', this._addressType,
    '--min_interval', this._connParams.minInterval,
    '--max_interval', this._connParams.maxInterval,
    '--latency',this._connParams.latency,
    '--supervision_timeout', this._connParams.supervisionTimeout
  ]);
