        ...
        switch(type) {
          ...
          case 0x07: // Complete List of 128-bit Service Class UUIDs
            for (j = 0; j < bytes.length; j += 16) {
              advertisement.serviceUuids.push(bytes.slice(j, j + 16).toString('hex').match(/.{1,2}/g).reverse().join(''));
            }
            break;
          ...
          case 0x16: // Service Data
            ...
            advertisement.serviceData = bytes.toString('hex');
            break;

          case 0xff: // Manufacturer Specific Data
            // TODO: maybe this should be a buffer, do we need to reverse?
            advertisement.manufacturerData = bytes.toString('hex');
            break;
        }
