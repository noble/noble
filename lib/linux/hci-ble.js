...
var HciBle = function(cfg) {
  this._cfg = cfg

  var hciBle = __dirname + '/../../build/Release/hci-ble';
  debug('hciBle = %s with hci%s', hciBle, this._cfg.NOBLE_HCI_DEVICE_ID);
  var env = {NOBLE_HCI_DEVICE_ID : this._cfg.NOBLE_HCI_DEVICE_ID || '0' }
  this._hciBle = spawn(hciBle, null, {env:env});
