...
NobleBindings.prototype.notify = function(identifier, serviceIdentifier, characteristicIdentifier, notify) {
  var characteristic = this._characteristicForIdentifier(identifier, serviceIdentifier, characteristicIdentifier);
...
NobleBindings.prototype.init = function(centralManager) {
  if(centralManager) {
