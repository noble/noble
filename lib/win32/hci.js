...
var BluetoothHciSocket = require('./hci-socket');
...
var STATUS_MAPPER = require('../hci-socket/hci-status');
...
Hci.prototype.init = function() {
  ...
  this._socket.on('up', this.onDevUp.bind(this));
  this._deviceId = this._socket.bindRaw();
};

Hci.prototype.onDevUp = function(isDevUp) {
