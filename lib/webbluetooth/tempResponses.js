...
//temporary data until web api is finished.  Based on LightBlue Bean and BLE-Serial services/characteristics.
...
module.exports.BEAN_CHARACTERISTICS = {
  ...
  "a495ff20c5b14b44b5121370f02d74de": [ { properties: [ 'read', 'write' ],
   ...
   "6e400001-b5a3-f393-e0a9-e50e24dcca9e": [ { properties: [ 'read', 'notify' ],
