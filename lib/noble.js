...
Noble.prototype.onConnect = function(peripheralUuid, error) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' connected!');
  }
};
...
Noble.prototype.onDisconnect = function(peripheralUuid) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' disconnected!');
  }
};
...
Noble.prototype.onRssiUpdate = function(peripheralUuid, rssi) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' RSSI update!');
  }
};
...
Noble.prototype.onServicesDiscover = function(peripheralUuid, serviceUuids) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' services discover!');
  }
};
...
Noble.prototype.onIncludedServicesDiscover = function(peripheralUuid, serviceUuid, includedServiceUuids) {
  ...
  if (service) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ' included services discover!');
  }
};
...
Noble.prototype.onCharacteristicsDiscover = function(peripheralUuid, serviceUuid, characteristics) {
  ...
  if (service) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ' characteristics discover!');
  }
};
...
Noble.prototype.onRead = function(peripheralUuid, serviceUuid, characteristicUuid, data, isNotification) {
  ...
  if (characteristic) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ' read!');
  }
};
...
Noble.prototype.onWrite = function(peripheralUuid, serviceUuid, characteristicUuid) {
  ...
  if (characteristic) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ' write!');
  }
};
...
Noble.prototype.onBroadcast = function(peripheralUuid, serviceUuid, characteristicUuid, state) {
  ...
  if (characteristic) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ' broadcast!');
  }
};
...
Noble.prototype.onNotify = function(peripheralUuid, serviceUuid, characteristicUuid, state) {
  ...
  if (characteristic) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ' notify!');
  }
};
...
Noble.prototype.onDescriptorsDiscover = function(peripheralUuid, serviceUuid, characteristicUuid, descriptors) {
  ...
  if (characteristic) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ' descriptors discover!');
  }
};
...
Noble.prototype.onValueRead = function(peripheralUuid, serviceUuid, characteristicUuid, descriptorUuid, data) {
  ...
  if (descriptor) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ', ' + descriptorUuid + ' value read!');
  }
};
...
Noble.prototype.onValueWrite = function(peripheralUuid, serviceUuid, characteristicUuid, descriptorUuid) {
  ...
  if (descriptor) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ', ' + serviceUuid + ', ' + characteristicUuid + ', ' + descriptorUuid + ' value write!');
  }
};
...
Noble.prototype.onHandleRead = function(peripheralUuid, handle, data) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' handle read!');
  }
};
...
Noble.prototype.onHandleWrite = function(peripheralUuid, handle) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' handle write!');
  }
};
...
Noble.prototype.onHandleNotify = function(peripheralUuid, handle, data) {
  ...
  if (peripheral) {
    ...
    this.emit('warning', 'noble: unknown peripheral ' + peripheralUuid + ' handle notify!');
  }
};
