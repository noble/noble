...
Noble.prototype.onServicesDiscover = function(peripheralUuid, serviceUuids, serviceHandles) {
  var peripheral = this._peripherals[peripheralUuid];
  ...
  if (peripheral) {
    ...
    for (var i = 0; i < serviceUuids.length; i++) {
	  ...
	  var serviceHandle = serviceHandles[i];
      var service = new Service(this, peripheralUuid, serviceUuid, serviceHandle);
