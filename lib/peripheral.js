...
Peripheral.prototype.connect = function(callback, should_emit) {
  if (callback && should_emit) {
...
Peripheral.prototype.disconnect = function(callback, should_emit) {
  if (callback && should_emit) {
...
Peripheral.prototype.discoverServices = function(uuids, callback, should_emit) {
  if (callback && should_emit) {
