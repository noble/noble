...
NobleBindings.prototype.startScanning = function(serviceUuids, allowDuplicates, alwaysClearPeripheralData) {
  this._scanServiceUuids = serviceUuids || [];

  this._gap.startScanning(allowDuplicates, alwaysClearPeripheralData);
};
