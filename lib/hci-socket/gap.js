...
Gap.prototype.startScanning = function(allowDuplicates, alwaysClearPeripheralData) {
  this._scanState = 'starting';
  this._scanFilterDuplicates = !allowDuplicates;
  this._alwaysClearPeripheralData = alwaysClearPeripheralData;
...
Gap.prototype.onHciLeAdvertisingReport = function(status, type, address, addressType, eir, rssi) {
  ...
  if (type === 0x04 || !connectable || ((this._alwaysClearPeripheralData ? discoveryCount > 0 : discoveryCount > 1) && !hasScanResponse) || process.env.NOBLE_REPORT_ALL_HCI_EVENTS) {
