...
Hci.prototype.createLeConn = function (address, addressType, parameters) {
  const minInterval = parameters && parameters.minInterval || 0x0006;
  const maxInterval = parameters && parameters.maxInterval || 0x000c;
  const latency = parameters && parameters.latency || 0x0000;
  const timeout = parameters && parameters.timeout || 0x00c8;
