...
var Hci = function(options) {
  ...
  this._deviceId =  options.deviceId ||
                    process.env.NOBLE_HCI_DEVICE_ID ? parseInt(process.env.NOBLE_HCI_DEVICE_ID, 10) : undefined;

  this._userChannel = typeof options.userChannel === 'undefined' && process.env.HCI_CHANNEL_USER || options.userChannel;
...
Hci.prototype.setScanParameters = function (interval, window) {
  interval = interval || 0x0010;
...
Hci.prototype.createLeConn = function(address, addressType, parameters) {
  var minInterval = parameters && parameters.minInterval || 0x0006;
  var maxInterval = parameters && parameters.maxInterval || 0x000c;
  var latency = parameters && parameters.latency || 0x0000;
  var timeout = parameters && parameters.timeout || 0x00c8;
