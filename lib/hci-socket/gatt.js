...
var UUID_FORMAT_16BITS = 1;
var UUID_FORMAT_128BITS = 2;
var HANDLE_SIZE_IN_BYTES = 2;
var UUID16_ID_SIZE_IN_BYTES = 2;
var UUID128_ID_SIZE_IN_BYTES = 16;
...
Gatt.prototype.extractUUIDs = function(data, uuidSizeInBytes) {
  var descriptors = [];
  var totalSizeInBytesPerUUID = uuidSizeInBytes + HANDLE_SIZE_IN_BYTES;
  var totalPositions = data.length / totalSizeInBytesPerUUID;
  for (var pos = 0; pos < totalPositions; pos++) {
    var positionInBytes = pos * totalSizeInBytesPerUUID;
    var handle = data.readUIntLE(positionInBytes, HANDLE_SIZE_IN_BYTES);
    var uuid = data
      .slice(
